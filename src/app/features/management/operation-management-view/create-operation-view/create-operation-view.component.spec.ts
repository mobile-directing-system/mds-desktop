import { CreateOperationViewComponent } from './create-operation-view.component';
...
function genFactoryOptions(): SpectatorRoutingOptions<CreateOperationViewComponent> {
  return {
...
describe('CreateOperationViewComponent', () => {
  let spectator: SpectatorRouting<CreateOperationViewComponent>;
  let component: CreateOperationViewComponent;
