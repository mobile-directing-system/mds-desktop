...
export class OperationService {
  ...
  /**
   * Creates the given operation and returns the newly created.
   * @param create Details for operation creation.
   */
   ...
   */
  getOperations(params: PaginationParams<OperationSort>) {
    interface NetEntry {
      id: string,
      title: string;
      description: string;
