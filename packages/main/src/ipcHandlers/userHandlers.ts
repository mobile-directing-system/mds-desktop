 ...
 * @returns boolean indicating if the user was updated in cached result container
 */
// eslint-disable-next-line no-unused-vars
export async function updateUserHandler(_:IpcMainInvokeEvent, user:User):Promise<CachedResult<boolean>> {
 ...
 * @returns boolean indicating if the user password was updated boolean in cached result container
 */
// eslint-disable-next-line no-unused-vars
export async function updateUserPasswordHandler(_:IpcMainInvokeEvent, userId: string, newPass: string):Promise<CachedResult<boolean>> {
 ...
 * @returns boolean indicating if the user was deleted in cached result container
 */
// eslint-disable-next-line no-unused-vars
export async function deleteUserHandler(_:IpcMainInvokeEvent, userId: string):Promise<CachedResult<boolean>> {
 ...
 * @returns received users in cached result container
 */
// eslint-disable-next-line no-unused-vars
 ...
 * @returns retrieved user in cached result conatiner
 */
// eslint-disable-next-line no-unused-vars
